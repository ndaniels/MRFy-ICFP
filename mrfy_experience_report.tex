...
generation. 
\end{itemize}
This interface provides considerable leeway for experiments.
...
easy.
\remark{I'm thinking this \P\ is not so strong. ---NR}
...
that is rarely used in computational biology.
...
\emph{We live to surf the Haskell wave, but~if you slide off the crest, you
drown.}
\par
\endgroup

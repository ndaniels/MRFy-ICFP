...
Our new Haskell code performs slower than the~C++
implementation of the same algorithm,
but still meets our performance goals,
and it was easy to parallelize
(\secref{perf}).
However, this algorithm is only one part of a larger
algorithm, which on the whole performs significantly
better than the~C++ software that precedes it.
\item

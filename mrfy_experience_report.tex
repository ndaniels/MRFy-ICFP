...
of seeing each specific amino acid letter at a given position. Triplets of 
insertion, deletion, and match states are grouped into ``nodes,'' which 
correspond to columns of the original alignment. What looks like an 
...
%% now explain computing a *parse* (HMMER) leading into Viterbi.

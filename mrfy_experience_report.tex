...
We found that documentation with straight-forward examples to be the most 
helpful.
...
is a great thing.
However, in the case where debugging extends into runtime behavior, there 
doesn't appear to be any clearly defined approach to effective debugging.
Stack traces are available via profiling, but this was difficult to find and 
as we mentioned, profiling has its own problems.

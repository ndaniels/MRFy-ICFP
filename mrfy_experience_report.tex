...
\remark{Two questions: (1)~Why isn't the function called \texttt{vee}?
(2)~Do we prefer \texttt{minimum (map from [Mat, Ins, Del])}?
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We expect that thanks to algebraic data types and typeclasses, these enhancements will be at
most a few weeks of work; we do not believe these enhancements would even be feasible in SMURF.
Indeed, Daniels tried to add another of these enhancements to SMURF two years ago and gave up due

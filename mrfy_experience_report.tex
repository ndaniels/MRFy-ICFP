...
\remark{TODO: 
(1)~Call the inner function \texttt{vee}
(2)~Use \texttt{minimum (map from [Mat, Ins, Del])}
(3)~Explain the recursive call
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
bugs.\remark{NR doesn't think the bug story is that interesting.}
...
Whatever the attractions of the code above, our work also

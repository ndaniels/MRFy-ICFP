...
\documentclass[preprint,nonatbib,blockstyle,times]{sigplanconf}
...
where each $x_i$~is 
an amino acid.
The number of amino acids $N$ can differ from the number of columns in the alignment,
...
the law % parallel structure for line breaking below
...
cost-center annotations must be added manually
to nested functions.
The annotations
made our code so ugly that we felt compelled to
remove them as soon as possible.
Nonetheless, GHC's profiler led us to the performance
improvements discussed in \secref{perf}.
...
and we look forward to further profiling MRFy.
...
\bibitem[Cowen et~al.(2002)Cowen, Bradley, Menke, King, and
  Berger]{Cowen:2002p588}
Lenore Cowen, Philip Bradley, Matt Menke, Jonathan King, and Bonnie Berger.
\newblock {Predicting the beta-helix fold from protein sequence data}.
\newblock \emph{Journal of Computational Biology}, 2002.

\bibitem[Daniels et~al.(2012)Daniels, Hosur, Berger, and Cowen]{Daniels:2012}
Noah Daniels, Raghavendra Hosur, Bonnie Berger, and Lenore Cowen.
\newblock {SMURFLite: combining simplified Markov random fields with simulated
  evolution improves remote homology detection for beta-structural proteins
  into the twilight zone}.
\newblock \emph{Bioinformatics}, March 2012.

\bibitem[Durbin et~al.(1998)Durbin, Eddy, Krogh, and Mitchison]{Durbin:1998wz}
...
\bibitem[Eddy(1998)]{Eddy:1998ut}
Sean Eddy.
\newblock {Profile hidden Markov models}.
\newblock \emph{Bioinformatics}, 14:\penalty0 755--763, 1998.

\bibitem[Hughes(1989)]{hughes:why}
John Hughes.
\newblock Why functional programming matters.
\newblock \emph{The Computer Journal}, 32\penalty0 (2):\penalty0 98--107, April
  1989.

\bibitem[Menke et~al.(2008)Menke, Berger, and Cowen]{Menke:2008wu}
Matthew Menke, Bonnie Berger, and Lenore Cowen.
\newblock {Matt: local flexibility aids protein multiple structure alignment}.
\newblock \emph{PLoS Computational Biology}, 2008.

\bibitem[Menke et~al.(2010)Menke, Berger, and Cowen]{Menke:2010ti}
Matthew Menke, Bonnie Berger, and Lenore Cowen.
\newblock {Markov random fields reveal an N-terminal double beta-propeller
  motif as part of a bacterial hybrid two-component sensor system}.
\newblock \emph{Proceedings of the National Academy of Science}, 2010.

\bibitem[Sansom and Peyton~Jones(1997)]{sansom-pj}
Patrick Sansom and Simon~L Peyton~Jones.
\newblock Formally based profiling for higher-order functional languages.
\newblock \emph{ACM TOPLAS}, 19\penalty0 (2):\penalty0 334--385, 1997.

\bibitem[Viterbi(1967)]{Viterbi:1967hq}
Andrew Viterbi.

...
\subsection{Software deltas}

\subsubsection{Reducing cases in Viterbi}

Original Viterbi took a state and two indices as argument, and it
dealt with impermissible transitions by assigning a very large score
(which translates to a very small probability).
Indices 1, 0, and $-1$ were all used to indicate special conditions,
and 
the function had 25~cases overall.
